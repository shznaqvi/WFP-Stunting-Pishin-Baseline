...
public class SectionCActivity extends Activity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        sHC.put("spblc01", spblc01a.isChecked() ? "1"
                : spblc01b.isChecked() ? "2"
                : spblc01c.isChecked() ? "3"
                : spblc01d.isChecked() ? "4"
                : spblc01e.isChecked() ? "5"
                : spblc01f.isChecked() ? "6"
                : spblc0188.isChecked() ? "88"
                : "0");


        sHC.put("spblc0188x", spblc0188x.getText().toString());


        sHC.put("spblc02", spblc02a.isChecked() ? "1"
                : spblc02b.isChecked() ? "2"
                : spblc02c.isChecked() ? "3"
                : spblc02d.isChecked() ? "4"
                : spblc02e.isChecked() ? "5"
                : spblc02f.isChecked() ? "6"
                : spblc02g.isChecked() ? "7"
                : spblc02h.isChecked() ? "8"
                : spblc02i.isChecked() ? "9"
                : spblc02j.isChecked() ? "10"
                : spblc02k.isChecked() ? "11"
                : spblc02l.isChecked() ? "12"
                : spblc02m.isChecked() ? "13"
                : spblc02n.isChecked() ? "14"
                : spblc02o.isChecked() ? "15"
                : spblc0288.isChecked() ? "88"
                : "0");

        sHC.put("spblc0288x", spblc0288x.getText().toString());


        sHC.put("spblc03", spblc03a.isChecked() ? "1"
                : spblc03b.isChecked() ? "2"
                : "0");

        sHC.put("spblc04", spblc04a.isChecked() ? "1"
                : spblc04b.isChecked() ? "2"
                : spblc04c.isChecked() ? "3"
                : spblc04d.isChecked() ? "4"
                : spblc04e.isChecked() ? "5"
                : spblc04f.isChecked() ? "6"
                : spblc0488.isChecked() ? "88"
                : "0");


        sHC.put("spblc0488x", spblc0488x.getText().toString());


        sHC.put("spblc05", spblc05a.isChecked() ? "1"
                : spblc05b.isChecked() ? "2"
                : spblc05c.isChecked() ? "3"
                : spblc05d.isChecked() ? "4"
                : spblc05e.isChecked() ? "5"
                : spblc05f.isChecked() ? "6"
                : spblc05g.isChecked() ? "7"
                : spblc05h.isChecked() ? "8"
                : spblc05i.isChecked() ? "9"
                : spblc05j.isChecked() ? "10"
                : spblc0588.isChecked() ? "88"
                : "0");


        sHC.put("spblc0588x", spblc0588x.getText().toString());

        sHC.put("spblc06", spblc06a.isChecked() ? "1"
                : spblc06b.isChecked() ? "2"
                : "0");

        sHC.put("spblc07", spblc07.getText().toString());


        sHC.put("spblc08a", spblc08aa.isChecked() ? "1"
                : spblc08ab.isChecked() ? "2"
                : "0");

        sHC.put("spblc08b", spblc08ba.isChecked() ? "1"
                : spblc08bb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08c", spblc08ca.isChecked() ? "1"
                : spblc08cb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08d", spblc08da.isChecked() ? "1"
                : spblc08db.isChecked() ? "2"
                : "0");

        sHC.put("spblc08e", spblc08ea.isChecked() ? "1"
                : spblc08eb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08f", spblc08fa.isChecked() ? "1"
                : spblc08fb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08g", spblc08ga.isChecked() ? "1"
                : spblc08gb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08h", spblc08ha.isChecked() ? "1"
                : spblc08hb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08i", spblc08ia.isChecked() ? "1"
                : spblc08ia.isChecked() ? "2"
                : "0");

        sHC.put("spblc08j", spblc08ja.isChecked() ? "1"
                : spblc08jb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08k", spblc08ka.isChecked() ? "1"
                : spblc08kb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08l", spblc08la.isChecked() ? "1"
                : spblc08lb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08m", spblc08ma.isChecked() ? "1"
                : spblc08mb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08n", spblc08na.isChecked() ? "1"
                : spblc08nb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08o", spblc08oa.isChecked() ? "1"
                : spblc08ob.isChecked() ? "2"
                : "0");

        sHC.put("spblc08p", spblc08pa.isChecked() ? "1"
                : spblc08pb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08q", spblc08qa.isChecked() ? "1"
                : spblc08qb.isChecked() ? "2"
                : "0");

        sHC.put("spblc08r", spblc08ra.isChecked() ? "1"
                : spblc08rb.isChecked() ? "2"
                : "0");

        sHC.put("spblc09", spblc09a.isChecked() ? "1"
                : spblc09b.isChecked() ? "2"
                : "0");
        ...
        sHC.put("spblc0988x", spblc0988x.getText().toString());

        sHC.put("spblc10", spblc10a.isChecked() ? "1"
                : spblc10b.isChecked() ? "2"
                : spblc10c.isChecked() ? "3"
                : spblc1088.isChecked() ? "88"
                : "0");


        sHC.put("spblc1088x", spblc1088x.getText().toString());


        sHC.put("spblc11", spblc11a.isChecked() ? "1"
                : spblc11b.isChecked() ? "2"
                : "0");


        sHC.put("spblc12", spblc12a.isChecked() ? "1"
                : spblc12b.isChecked() ? "2"
                : spblc12c.isChecked() ? "3"
                : spblc12d.isChecked() ? "4"
                : spblc12e.isChecked() ? "5"
                : spblc12f.isChecked() ? "6"
                : spblc12g.isChecked() ? "7"
                : spblc12h.isChecked() ? "8"
                : spblc12i.isChecked() ? "9"
                : spblc12j.isChecked() ? "10"
                : spblc12k.isChecked() ? "11"
                : spblc12l.isChecked() ? "12"
                : spblc12m.isChecked() ? "13"
                : spblc1288.isChecked() ? "88"
                : "0");

        sHC.put("spblc1288x", spblc1288x.getText().toString());


        sHC.put("spblc13", spblc13a.isChecked() ? "1"
                : spblc13b.isChecked() ? "2"
                : spblc13c.isChecked() ? "3"
                : spblc13d.isChecked() ? "4"
                : spblc13e.isChecked() ? "5"
                : spblc13f.isChecked() ? "6"
                : spblc13g.isChecked() ? "7"
                : spblc13h.isChecked() ? "8"
                : spblc13i.isChecked() ? "9"
                : spblc13j.isChecked() ? "10"
                : spblc13k.isChecked() ? "11"
                : spblc13l.isChecked() ? "12"
                : spblc13m.isChecked() ? "13"
                : spblc13n.isChecked() ? "14"
                : spblc1388.isChecked() ? "88"
                : "0");

        sHC.put("spblc1388x", spblc1388x.getText().toString());


        sHC.put("spblc14", spblc14a.isChecked() ? "1"
                : spblc14b.isChecked() ? "2"
                : spblc14c.isChecked() ? "3"
                : spblc14d.isChecked() ? "4"
                : spblc14e.isChecked() ? "5"
                : spblc14f.isChecked() ? "6"
                : spblc14g.isChecked() ? "7"
                : spblc14h.isChecked() ? "8"
                : spblc14i.isChecked() ? "9"
                : spblc14j.isChecked() ? "10"
                : spblc14k.isChecked() ? "11"
                : spblc14l.isChecked() ? "12"
                : spblc14m.isChecked() ? "13"
                : spblc14n.isChecked() ? "14"
                : spblc14o.isChecked() ? "15"
                : spblc14p.isChecked() ? "16"
                : spblc14q.isChecked() ? "17"
                : spblc14r.isChecked() ? "18"
                : spblc14s.isChecked() ? "19"
                : spblc14t.isChecked() ? "20"
                : spblc14u.isChecked() ? "21"
                : spblc1488.isChecked() ? "88"
                : "0");

        sHC.put("spblc1488x", spblc1488x.getText().toString());

        sHC.put("spblc15", spblc15.getText().toString());

        sHC.put("spblc16a", spblc16aa.isChecked() ? "1"
                : spblc16ab.isChecked() ? "2"
                : "0");

        sHC.put("spblc16b", spblc16ba.isChecked() ? "1"
                : spblc16bb.isChecked() ? "2"
                : "0");

        sHC.put("spblc16c", spblc16ca.isChecked() ? "1"
                : spblc16cb.isChecked() ? "2"
                : "0");

        sHC.put("spblc16d", spblc16da.isChecked() ? "1"
                : spblc16db.isChecked() ? "2"
                : "0");

        sHC.put("spblc16e", spblc16ea.isChecked() ? "1"
                : spblc16eb.isChecked() ? "2"
                : "0");

        sHC.put("spblc16f", spblc16fa.isChecked() ? "1"
                : spblc16fb.isChecked() ? "2"
                : "0");

        sHC.put("spblc16g", spblc16ga.isChecked() ? "1"
                : spblc16gb.isChecked() ? "2"
                : "0");

        sHC.put("spblc16h", spblc16ha.isChecked() ? "1"
                : spblc16hb.isChecked() ? "2"
                : "0");

        sHC.put("spblc16i", spblc16ia.isChecked() ? "1"
                : spblc16ib.isChecked() ? "2"
                : "0");

        sHC.put("spblc17", spblc17a.isChecked() ? "1"
                : spblc17b.isChecked() ? "2"
                : "0");

        sHC.put("spblc18", spblc18a.isChecked() ? "1"
                : spblc18b.isChecked() ? "2"
                : spblc18c.isChecked() ? "2"
                : spblc1899.isChecked() ? "2"
                : "0");

        sHC.put("spblc18ac", spblc18ac.getText().toString());
        sHC.put("spblc18kn", spblc18kn.getText().toString());
        sHC.put("spblc1ckn", spblc1ckn.getText().toString());


        sHC.put("spblc19", spblc19a.isChecked() ? "1"
                : spblc19b.isChecked() ? "2"
                : "0");

        sHC.put("spblc20a", spblc20a.getText().toString());
        sHC.put("spblc20b", spblc20b.getText().toString());
        sHC.put("spblc20c", spblc20c.getText().toString());
        sHC.put("spblc20d", spblc20d.getText().toString());
        sHC.put("spblc20e", spblc20e.getText().toString());
        sHC.put("spblc20f", spblc20f.getText().toString());


        MainApp.fc.setsHC(String.valueOf(sHC));
